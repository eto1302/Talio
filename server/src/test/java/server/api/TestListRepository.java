...
public class TestListRepository implements ListRepositoy {
    ...
    @Override
    public java.util.List<List> findAllById(Iterable<Integer> integers) {
        return null;
    }
    ...
    @Override
    public Optional<List> findById(Integer integer) {
    ...
    @Override
    public List getOne(Integer integer) {
        return null;
    }

    @Override
    public List getById(Integer integer) {
        return null;
    }
