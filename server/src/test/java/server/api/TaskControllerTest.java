...
class TaskControllerTest {
    ...
    private transient Task task1 = Task.create("No description yet", "Task 1", 1, new ArrayList<>());
    private transient  Task task2 = Task.create("Getting food", "Task 2", 1, new ArrayList<>());
    ...
    void testGetTask() throws Exception{
        ...
        response.andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.title", CoreMatchers.is(task1.getTitle())));
    }
    ...
    void testGetByList() throws Exception{
        ...
        response.andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.size()", CoreMatchers.is(Arrays.asList(task1, task2).size())))
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].description", CoreMatchers.is(task1.getDescription())))
                .andExpect(MockMvcResultMatchers.jsonPath("$[1].title", CoreMatchers.is(task2.getTitle())));
    }
    ...
    void testEditTask() throws Exception{
        ...
        TaskEditModel taskEditModel = new TaskEditModel("Watching movies", "Task 3", 1, new List(), 1);
