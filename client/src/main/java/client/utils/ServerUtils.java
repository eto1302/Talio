...
public class ServerUtils implements IServerUtils {
    ...
    public IdResponseModel editColor(int colorId, ColorEditModel model) {
        try {
            ...
            if (colorId != response.getBody().getId())
                return new IdResponseModel(-1, "Color doesn't match");
    ...
    public IdResponseModel deleteTask(int taskID, int listID) {
        try {
            ResponseEntity<IdResponseModel> response = client.exchange(
                    url + "task/delete/" + taskID + "/" + listID, HttpMethod.DELETE, null,
    ...
    public IdResponseModel editTask(int taskId, commons.models.TaskEditModel model) {
        try {
            ...
            ResponseEntity<IdResponseModel> response = client.exchange(
                    ...
                    req, IdResponseModel.class);
            if (taskId != response.getBody().getId())
                return new IdResponseModel(-1, "Task doesn't match");
            return response.getBody();
        } catch (Exception e) {
            return new IdResponseModel(-1, "Oops, failed to connect to server...");
        }
     ...
     */
    public ResponseEntity<Task[]> getTaskByList(int listID) {
        return client.getForEntity(
                url + "task/getByList/" + listID, Task[].class);
    }
     ...
     */
    public ResponseEntity<Task[]> getTasksOrdered(int listID) {
        return client.getForEntity(
                url + "task/getOrdered/" + listID, Task[].class);
    }
    ...
    public IdResponseModel editSubtask(int subtaskID, SubtaskEditModel model) {
        try {
            ...
            if (subtaskID != response.getBody().getId())
                return new IdResponseModel(-1, "Subtask doesn't match");
            return response.getBody();
     ...
     */
    public ResponseEntity<Subtask[]> getSubtasksByTask(int taskID) {
        return client.getForEntity(
                url + "subtask/getByTask/" + taskID, Subtask[].class);
    }
    ...
    public IdResponseModel editTag(int tagID, TagEditModel model) {
        try {
            ...
            if (tagID != response.getBody().getId())
                return new IdResponseModel(-1, "Tag doesn't match");
            return response.getBody();
        } catch (Exception e) {
            return new IdResponseModel(-1, "Oops, failed to connect to server...");
        }
    ...
    public IdResponseModel deleteTag(int tagID) {
        try {
            ResponseEntity<IdResponseModel> response = client.exchange(
                    url + "tag/delete/" + tagID, HttpMethod.DELETE,
                    null, IdResponseModel.class);
            return response.getBody();
        } catch (Exception e) {
            return new IdResponseModel(-1, "Oops, failed to connect to server...");
     ...
     */
    public ResponseEntity<Tag> getTag(int id) {
        return client.getForEntity(
     ...
     */
    public ResponseEntity<Tag[]> getTagsByTask(int taskID) {
        return client.getForEntity(
                url + "tag/getByTask/" + taskID, Tag[].class);
    }
     ...
     */
    public ResponseEntity<Tag[]> getTagByBoard(int boardID) {
        return client.getForEntity(
                url + "tag/getByBoard/" + boardID, Tag[].class);
    }
     ...
     */
    public ResponseEntity<Subtask[]> getSubtasksOrdered(int taskID) {
        return client.getForEntity(
                url + "subtask/getOrdered/" + taskID, Subtask[].class);
    }
