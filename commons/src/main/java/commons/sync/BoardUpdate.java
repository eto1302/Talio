...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = SubtaskAdded.class, name = "subtaskAdded"),
    @JsonSubTypes.Type(value = SubtaskEdited.class, name = "subtaskEdited"),
    @JsonSubTypes.Type(value = SubtaskDeleted.class, name = "subtaskDeleted"),
